...
Feature: PreApproval Details
  ...
  Scenario:pass result
    ...
    Then The Source of Down Payment field should have a drop-down menu with options such as "Checking/Savings", "Equity on Pending Sale", and "Other type of Down Payment".
