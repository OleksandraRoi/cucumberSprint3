...
public class userStory3POST {
    ...
    public void the_new_user_was_created() {
    ...
    public void json_response_and_header_as(String string, String string2) {

    }
    @Then("the response must be less than {int} ms")
    public void the_response_must_be_less_than_ms(Integer int1) {
    ...
    @Then("API should return a {int} Unprocessable Entity error with a message {string}")
    public void api_should_return_a_unprocessable_entity_error_with_a_message(Integer int1, String string) {
